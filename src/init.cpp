...
void init() {
	...
	abstract_root = share_memory(key + 1, abstractHashSize * 2+1, abstract_root, root+0x100000000);
	name_root = share_memory(key + 2, maxNodes*averageNameLength, name_root,root+0x200000000);
	statement_root = share_memory(key + 3,(int) maxStatements0*statementSize,statement_root, root+0x300000000);
